...
<head>
    ...
    <title>Rekening Koran Tabungan Umrah - {{ $siteSettings['seo_site_title'] ?? config('app.name') }}</title>
    ...
    <style>
        ...
        @media print {
            ...
            .print-shadowless { box-shadow:none !important; }
            .print-borderless { border:0 !important; }
            ...
            <div class="flex items-center gap-4 min-w-0">
                ...
                <div class="min-w-0">
                    <div class="text-lg font-extrabold text-slate-900 leading-tight">
                        Rekening Koran Tabungan Umrah
                    </div>
                    <div class="text-sm text-slate-500 font-bold">
                        Mutasi tabungan berdasarkan transaksi pada sistem
                    </div>
                </div>
            </div>

            <div class="text-right">
                <div class="text-xs text-slate-500 font-extrabold">Nomor Statement</div>
                <div class="text-sm font-extrabold text-slate-900">{{ $statementNo ?? '-' }}</div>

                <div class="mt-2 text-xs text-slate-500 font-extrabold">Dicetak</div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="border border-slate-200 rounded-2xl p-4">
                    <div class="text-xs text-slate-500 font-extrabold">Data Nasabah</div>

                    <div class="mt-3 grid grid-cols-1 gap-2">
                        <div>
                            <div class="text-xs text-slate-500 font-extrabold">Nama</div>
                        ...
                        <div>
                            <div class="text-xs text-slate-500 font-extrabold">Jenis Tabungan</div>
                            <div class="text-sm font-extrabold text-slate-900">
                ...
                <div class="border border-slate-200 rounded-2xl p-4">
                    <div class="text-xs text-slate-500 font-extrabold">Periode & Ringkasan</div>

                    <div class="mt-3 grid grid-cols-1 gap-2">
                        <div>
                            <div class="text-xs text-slate-500 font-extrabold">Periode</div>
                            <div class="text-sm font-extrabold text-slate-900">
                        ...
                        <div class="grid grid-cols-2 gap-3 pt-2">
                            <div class="border border-slate-200 rounded-2xl p-3">
                                <div class="text-xs text-slate-500 font-extrabold">Saldo Awal</div>
                                <div class="mt-1 text-sm font-extrabold text-slate-900">
                                    Rp {{ number_format((int)($openingBalance ?? 0), 0, ',', '.') }}
                                </div>
                            </div>
                            <div class="border border-slate-200 rounded-2xl p-3">
                                <div class="text-xs text-slate-500 font-extrabold">Saldo Akhir</div>
                                <div class="mt-1 text-sm font-extrabold text-slate-900">
                        ...
                        <div class="pt-2">
                            <div class="text-xs text-slate-500 font-extrabold">Total Kredit (approved)</div>
                            <div class="text-sm font-extrabold text-slate-900">
            ...
            <div class="mt-6 border border-slate-200 rounded-2xl overflow-hidden">
                <table class="w-full text-sm">
                    ...
                    <tr class="text-left text-xs text-slate-500 font-extrabold">
                        <th class="p-3 w-[150px]">Tanggal</th>
                        <th class="p-3">Keterangan</th>
                        <th class="p-3 w-[120px]">Ref</th>
                        <th class="p-3 w-[110px] text-right">Debit</th>
                        <th class="p-3 w-[110px] text-right">Kredit</th>
                        <th class="p-3 w-[130px] text-right">Saldo</th>
                    </tr>
                    </thead>
                    ...
                    <tr>
                        ...
                        <td class="p-3 font-extrabold text-slate-900">Saldo Awal</td>
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="border border-slate-200 rounded-2xl p-4">
                    <div class="text-xs text-slate-500 font-extrabold">Catatan</div>
                    <div class="mt-2 text-sm text-slate-600 font-bold leading-relaxed">
                        Saldo berjalan hanya berubah oleh transaksi berstatus <span class="font-extrabold text-slate-900">approved</span>.
                        Transaksi pending/ditolak ditampilkan untuk kebutuhan audit.
                    </div>
                </div>

                <div class="border border-slate-200 rounded-2xl p-4">
                    <div class="text-xs text-slate-500 font-extrabold">Dicetak oleh</div>
