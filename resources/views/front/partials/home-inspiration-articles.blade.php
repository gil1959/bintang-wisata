{{-- resources/views/front/partials/home-inspiration-articles.blade.php --}}
                    ...
                    <a href="{{ $href }}" class="block">
                        <div class="relative aspect-[16/10] bg-slate-100 overflow-hidden">
                            ...
                            @else
                                ...
                                <div class="absolute inset-0 grid place-items-center text-slate-500 text-xs">No Image</div>
                            @endif
