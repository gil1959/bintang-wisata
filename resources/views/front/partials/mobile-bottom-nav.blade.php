@php
  // ✅ MOBILE NAV 6 item:
  // Home, Tour, Rental, Kapal, Umrah, Dokumentasi (langsung link ke Dokumentasi Tour)
  $mobileNav = [
    ['route' => 'home',         'icon' => 'home',      'mobile_label' => 'Home'],
    ['route' => 'tours.index',  'icon' => 'map',       'mobile_label' => 'Tour'],
    ['route' => 'rentcar.index','icon' => 'car',       'mobile_label' => 'Rental'],
    ['route' => 'ship.index',   'icon' => 'anchor',    'mobile_label' => 'Kapal'],
    ['route' => 'umrah.index',  'icon' => 'landmark',  'mobile_label' => 'Umrah'],
    ['route' => 'docs',         'icon' => 'book-open', 'mobile_label' => 'Docs'],
  ];
@endphp
