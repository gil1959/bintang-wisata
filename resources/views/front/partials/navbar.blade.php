<header
  ...
  <div class="max-w-7xl mx-auto px-4 py-2 lg:py-4 flex items-center gap-3">
    ...
    {{-- DESKTOP NAV --}}
    <nav class="hidden lg:flex flex-1 items-center justify-center gap-1 flex-nowrap whitespace-nowrap">
      @php
      ...
      <div x-data="{ open:false }"
        ...
        <button type="button"
          ...
          <span>{{ $isEn ? 'Docs' : 'Dokumentasi' }}</span>
        ...
        <div x-show="open" x-transition x-cloak
          ...
          <a href="{{ route('docs') }}"
            ...
            {{ $isEn ? 'Tour Documentation' : 'Dokumentasi Tour' }}
          </a>

          <a href="{{ route('docs.ship') }}"
            class="flex items-center gap-2 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50">
            <i data-lucide="anchor" class="w-4 h-4" style="color:#0194F3;"></i>
            {{ $isEn ? 'Ship Rental Documentation' : 'Dokumentasi Sewa Kapal' }}
          </a>
