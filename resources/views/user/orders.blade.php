...
@section('page-subtitle', 'Kelola & pantau transaksi kamu')

@section('content')
    <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm mb-5">
        <div class="flex items-center justify-between gap-3">
            <h2 class="text-sm font-extrabold text-slate-900">Filter</h2>
        ...
        <form method="GET" class="mt-4 grid grid-cols-1 md:grid-cols-12 gap-3">
            <div class="md:col-span-5">
                ...
                <input class="input" name="search" value="{{ request('search') }}" placeholder="Invoice / Nama produk...">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <select class="input" name="type">
                    ...
                    <option value="rent_car" @selected(request('type')==='rent_car')>Rent Car</option>
                </select>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <select class="input" name="order_status">
                    ...
                    <option value="approved" @selected(request('order_status')==='approved')>Approved</option>
                    <option value="rejected" @selected(request('order_status')==='rejected')>Rejected</option>
                </select>
            </div>
            ...
            <div class="md:col-span-3">
                ...
                <select class="input" name="payment_status">
                    <option value="">All</option>
                    <option value="waiting_payment" @selected(request('payment_status')==='waiting_payment')>Waiting Payment</option>
                    <option value="waiting_verification" @selected(request('payment_status')==='waiting_verification')>Waiting Verification</option>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
        <div class="flex items-center justify-between gap-3">
            <h2 class="text-sm font-extrabold text-slate-900">Daftar Orders</h2>
            ...
            <table class="min-w-full text-sm">
                <thead class="bg-slate-50 text-slate-600">
                    <tr>
                        ...
                        <th class="text-right px-5 py-3 font-bold">Action</th>
                    </tr>
                </thead>
