...
@section('page-subtitle', 'Registrasi tabungan umrah')
...
@section('content')
    ...
    <div class="card p-5 relative overflow-hidden">
        ...
        <div class="flex items-start justify-between gap-3 relative">
            <div>
                <h2 class="text-sm font-extrabold text-slate-900">Registrasi Jamaah Baru</h2>
                <p class="text-sm text-slate-500 mt-1">Isi data di bawah untuk mengajukan tabungan umrah.</p>
            </div>
