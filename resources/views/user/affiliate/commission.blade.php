...
<div class="space-y-5">
  <div>
    ...
    <p class="mt-1 text-sm text-slate-600">Komisi dari order yang masuk lewat link kamu.</p>
  </div>
  ...
  <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">
    <div class="p-4 border-b border-slate-200">
      <div class="text-sm font-extrabold text-slate-900">Order Affiliate</div>
    </div>
    ...
    <div class="overflow-x-auto">
      <table class="min-w-full text-sm">
        ...
        <tbody class="divide-y divide-slate-200">
          ...
          @empty
            <tr><td class="px-4 py-6 text-slate-600" colspan="5">Belum ada order affiliate.</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
