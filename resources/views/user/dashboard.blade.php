...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-5">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm hover:shadow-md transition relative overflow-hidden">
            ...
            <div class="flex items-start justify-between relative">
                <div>
                    ...
                    <div class="mt-1 text-xs text-slate-500">Jumlah transaksi yang tercatat</div>
                </div>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm hover:shadow-md transition relative overflow-hidden">
            ...
            <div class="flex items-start justify-between relative">
                <div>
                    <div class="text-xs font-extrabold text-slate-500">Menunggu Pembayaran</div>
                    <div class="mt-2 text-2xl font-extrabold text-slate-900">{{ $waitingPayment }}</div>
                    <div class="mt-1 text-xs text-slate-500">Butuh tindakan dari kamu</div>
                </div>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm hover:shadow-md transition relative overflow-hidden">
            ...
            <div class="flex items-start justify-between relative">
                <div>
                    <div class="text-xs font-extrabold text-slate-500">Verifikasi</div>
                    <div class="mt-2 text-2xl font-extrabold text-slate-900">{{ $waitingVerification }}</div>
                    <div class="mt-1 text-xs text-slate-500">Sedang dicek admin</div>
                </div>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm hover:shadow-md transition relative overflow-hidden">
            ...
            <div class="flex items-start justify-between relative">
                <div>
                    <div class="text-xs font-extrabold text-slate-500">Total Spend (Paid)</div>
                    <div class="mt-2 text-2xl font-extrabold" style="color:#0194F3;">
                        Rp {{ number_format($totalSpend ?? 0, 0, ',', '.') }}
                    </div>
                    <div class="mt-1 text-xs text-slate-500">Akumulasi transaksi lunas</div>
                </div>
    ...
    <div class="grid grid-cols-1 2xl:grid-cols-12 gap-5">
        ...
        <div class="2xl:col-span-5 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
            <div class="flex items-center justify-between gap-3">
                <h2 class="text-sm font-extrabold text-slate-900">Ringkasan Status</h2>
            ...
            <div class="mt-4 text-xs text-slate-500">
                Tip: cek tab Orders untuk detail status pembayaran.
            </div>
        </div>
