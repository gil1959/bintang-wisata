...
<head>
    <meta charset="UTF-8">
    <title>E-Ticket - {{ $order->invoice_number }}</title>
...
<body class="text-slate-900">
    <div class="ticket-print-shell">
        ...
        <div class="no-print flex items-center justify-between gap-4 mb-5">
            <div>
                <div class="text-xl font-extrabold text-slate-900">Bintang Wisata · E-Ticket</div>
        ...
        {{-- ═══════════════ PRINT: boarding pass (203mm × 82mm) ═══════════════ --}}
        @php
        ...
        $bpKelasMap = [
        'F'=>'First','A'=>'First','C'=>'Business','D'=>'Business',
        'I'=>'Business','Z'=>'Business','Y'=>'Economy','B'=>'Economy',
        'M'=>'Economy','H'=>'Economy','K'=>'Economy','L'=>'Economy',
        'Q'=>'Economy','T'=>'Economy','N'=>'Economy','R'=>'Economy',
        'S'=>'Economy','V'=>'Economy','W'=>'Economy','X'=>'Economy',
        'O'=>'Economy','P'=>'Economy','G'=>'Economy','E'=>'Economy',
        ];
        ...
        <div class="bp-boarding-pass" id="bpBoardingPass">
            ...
            <div class="bp-main">
                ...
                <div class="bp-header">
                    ...
                    @if($bpStatus2)
                    <span class="bp-status-badge">{{ $bpStatus2 }}</span>
                    @endif
                </div>
                ...
                @php
                $bfKr = strtoupper(trim((string) ($bfd['fdFlightClass'] ?? '')));
                $bfKelas = $bpKelasMap[$bfKr] ?? 'Economy';
                $bfFlight = trim((string) ($bfd['flightNumber'] ?? '-'));
                @endphp
                <div class="bp-flight">
                    ...
                    <div class="bp-flight-row">
                        ...
                        <div class="bp-route-line">
                            <div class="bp-flight-badge">
                                {{-- Plane facing right for departure --}}
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"
                                    viewBox="0 0 24 24" fill="#0194F3"
                            ...
                            <div class="bp-class-label" style="position:absolute;display:none;"></div>
                        </div>
                ...
                @php
                $bfKr = strtoupper(trim((string) ($bfr['fdFlightClass'] ?? '')));
                $bfKelas = $bpKelasMap[$bfKr] ?? 'Economy';
                $bfFlight = trim((string) ($bfr['flightNumber'] ?? '-'));
                @endphp
                <div class="bp-flight">
                ...
                {{-- Footer --}}
                <div class="bp-footer" style="margin-top:auto;">
                    ...
                    <div class="bp-footer-cell">
                        ...
                        <div class="bp-footer-value">
                            {{ !empty($bpIssued) ? \Carbon\Carbon::parse($bpIssued)->format('d/m/Y H:i') : '-' }}
                        </div>
                    </div>
                </div>
            ...
            <div class="bp-stub">
                <div class="bp-stub-top">
                    ...
                    @if($bpStatus2)
                    <div><span class="bp-stub-status">{{ $bpStatus2 }}</span></div>
                    @endif
                </div>

                @if($bpQrVal)
                <div class="bp-stub-qr" data-ticket-qr="{{ e($bpQrVal) }}" data-ticket-qr-size="136"></div>
                @endif

                <div>
                    @if($bpBookCode)
                    <div class="bp-stub-code-label">Booking Code</div>
                    <div class="bp-stub-code-value">{{ $bpBookCode }}</div>
                    @endif
                    @if($bpRefNo)
                    <div class="bp-stub-ref">Ref: {{ $bpRefNo }}</div>
                    @endif
                </div>
            </div>{{-- end .bp-stub --}}

        </div>{{-- end .bp-boarding-pass --}}
        ...
        (function() {
            function renderTicketQrs() {
                document.querySelectorAll('[data-ticket-qr]').forEach(function(el) {
                    ...
                    var size = parseInt(el.getAttribute('data-ticket-qr-size') || '140', 10);
